...
function useActions(state, nodeLookup, edgeLookup) {
  ...
  const updateNodePositions = (dragItems, changed, dragging, skipTrigger = false) => {
    var _a, _b;
    const changes = [];
    ...
    if ((changes == null ? void 0 : changes.length) && !skipTrigger) {
...
const _sfc_main$8 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const shouldSelectOnDrag = vue.toRef(() => selectionKeyCode.value === true && shouldPanOnDrag.value !== true);
    const isSelecting = vue.toRef(
      ...
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        ...
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(getEdges), (edge) => {
          return vue.openBlock(), vue.createElementBlock("svg", {
            ...
            vue.createVNode(vue.unref(EdgeWrapper), {
              id: edge.id
            }, null, 8, ["id"])
          ], 4);
        }), 128)),
        vue.createVNode(vue.unref(ConnectionLine))
      ], 64);
    };
  }
});
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$1, [
        resizeObserver.value ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, { key: 0 }, vue.renderList(vue.unref(getNodes), (node, __, ___, _cached) => {
          const _memo = [node.id];
          if (_cached && _cached.key === node.id && vue.isMemoSame(_cached, _memo)) return _cached;
          const _item = (vue.openBlock(), vue.createBlock(vue.unref(NodeWrapper), {
            id: node.id,
            key: node.id,
